...
def process_feat(imgs_desc, imgs_desc_dino, ONLY_DINO = False, CO_PCA = False, CO_PCA_DINO = False ):
    ...
    #print(imgs_desc['s5'].shape, imgs_desc['s4'].shape)
    ...
    if ONLY_DINO: return imgs_desc_dino
    else: return  imgs_desc_dino, imgs_desc
